...
\begin{lstlisting}[caption=Schema for adjacency list, label=lst_adj_list, float]
CREATE TABLE Nodes (
...
\begin{lstlisting}[caption=SQL for querying child nodes., label=fig:child_query, float]
...
\begin{lstlisting}[style=java, caption=Root for Adjacency List, label=lst_aj_root, float]
...
\begin{lstlisting}[caption={Parent, Children, and Sibling}, label=lst_aj_parent, float]
--
...
\begin{lstlisting}[style=java, caption=Leaves, label=lst_aj_leaves, float]
